...
public class MovieCatalogController {
	...
	private static Logger LOG = LoggerFactory.getLogger(MovieCatalogController.class.getName());
	...
	public ResponseEntity<MovieCatalog> getMovieCatalogByUsername(@PathVariable String username) {
		...
		LOG.info("Inside MovieCatalogService::getMovieCatalogByUsername() method."); 
		...
		LOG.info("Inside MovieCatalogService: Response => " + movieCatalog);
